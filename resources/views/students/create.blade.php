            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student-store') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Повтор пароль</label>
                        ...
                        <div class=" row">
                            <div class="col-md-4">
                                ...
                                <label for="role_id" style="float: right">Доступ</label>
                            </div>
                            <div class="col-md-6">
                            <select name="role_id" id="role_id" class="form-select">
                                <option selected>Выберите роль</option>
                                @foreach($roles as $role)
                                    <option value="{{ $role->id}}" class="form-option">{{ $role->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        </div>
